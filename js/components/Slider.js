/**
 * Disclaimer. This component is a modified version of Slider found in react-native-elements library.
 * See https://github.com/react-native-training/react-native-elements
 * 
 */

import React, { Component } from 'react';
import PropTypes from 'prop-types';
import { View, StyleSheet, Animated, Easing, PanResponder, ViewPropTypes as RNViewPropTypes } from 'react-native';
...
export default class Slider extends Component {
    ...
    handleMeasure(name, x) {
        ...
        var width = this.props.orientation === 'vertical' ? layout.height : layout.width;
        var height = this.props.orientation === 'vertical' ? layout.width : layout.height;
        ...
        return (
            <View
                ...
                style={StyleSheet.flatten([                    
                    orientation === 'vertical' ? mainStyles.containerVertical : mainStyles.containerHorizontal,
                    style,
                ])}
            ...
            >
                ...
                <Animated.View
                    ...
                    style={StyleSheet.flatten([
                        ...
                        mainStyles.thumb,
                        orientation === 'vertical' ? mainStyles.thumbVertical : mainStyles.thumbHoizontal,
                        thumbStyle,
                        {
                            transform: [
